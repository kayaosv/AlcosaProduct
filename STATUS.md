...
- [ ] **Probar en el celular real la mejora de cámara del escáner**
  (resolución 1920×1080, `TRY_HARDER`, zoom/linterna —
  specs/escaner-camara-codigos-dificiles.md, commit `859946f`). **Ya está
  en `main` desde 2026-09-25** (entró junto con el merge del selector de
  variantes del TPV, `9d5bad8`), pero el cliente todavía no la probó en
  su celular real. Si falla, revertir `859946f` de main.
