...
export const CartDrawer = () => {
  ...
  // fought this open/close toggle and left the drawer snapped back
  // off-screen while only the backdrop's fade/blur played through.
  // Confirmed by temporarily stripping the animation entirely: the panel
  // rendered correctly, isolating the bug to the GSAP/useGSAP interaction.
  useEffect(() => {
    if (open) {
