...
// Sin preload manual: el modelo 3D se carga solo cuando la seccion esta
// por aparecer (useInView, con margen de adelanto), no antes - ver
// ProductCard3D (recibe `active` y decide cuando montar el modelo real).
